...
# on information extraction. He decides to try a simple implementation of TF
# -IDF, a measure of the information content a term holds for a particular
...
def idf(term, documents)
  ...
  Math.log(number_of_documents.to_f / number_of_documents_with_term) # new code: added to_f
end
