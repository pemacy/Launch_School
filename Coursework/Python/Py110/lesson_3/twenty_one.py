...
def generate_card_title_line(player):
    ...
    '''
    spacer = '  '
    line = card_line_3(first_card_display(player)) + spacer
...
def is_risk_level_exceeded(player):
    ...
    '''
    if player['type'] != 'human' and player['hand_value'] <= RISK_LEVELS[player['risk_level']]:
        return True
    return False
