'''
Nested Data Structure Practice Problems
'''
...
Given the object shown below, print the name, age, and gender of each family
member:
'''
...
print(F"{list(munsters.keys())[0]} is a {munsters['Herman']['age']} year old",
      F" {munsters['Herman']['gender']}.")
